...
$routes = [
    "/"       => "http://localhost/junaidphp/notes-app/controllers/index.php",
    "/about"  => "http://localhost/junaidphp/notes-app/controllers/about.php",
    "/contact"=> "http://localhost/junaidphp/notes-app/controllers/contact.php"
];
