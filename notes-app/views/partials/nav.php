          ...
          <div class="hidden md:block">
            <div class="ml-10 flex items-baseline space-x-4">
              <!-- Current: "bg-gray-900 text-white", Default: "text-gray-300 hover:bg-white/5 hover:text-white" -->
               <a href="http://localhost/junaidphp/notes-app/controllers/index.php" aria-current="page" class="<?= urlIs("/") ? "bg-gray-900 text-white" : "text-gray-300"?> block rounded-md bg-gray-900 px-3 py-2 text-base font-medium text-white">Home</a>
               <a href="http://localhost/junaidphp/notes-app/controllers/about.php" class="<?= urlIs("/about") ? "bg-gray-900 text-white" : "text-gray-300"?> block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
              <a href="http://localhost/junaidphp/notes-app/controllers/contact.php" class="<?= urlIs("/contact") ? "bg-gray-900 text-white" : "text-gray-300"?> block rounded-md px-3 py-2 text-base font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact</a>
            </div>
          </div>
        </div>
        <div class="hidden md:block">
